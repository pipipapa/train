...
<body>
	<h2>新增车次</h2>
	<form action="AddTrain" method="post" class="leftform">
	    <input name="name" type="text" id="name" class="textbox textbox_295" placeholder="车次名称"/></br>
	    ...
	    <input name="stime" placeholder="发车时间" type="text" class="textbox textbox_295" id="creattimeid" size="13" value=''  onclick="setDate(this,'yyyy/MM/dd HH:mm')"><br> 
	    <input name="etime" placeholder="到站时间" type="text" class="textbox textbox_295" id="creattimeid" size="13" value=''  onclick="setDate(this,'yyyy/MM/dd HH:mm')"><br> 
	    
	    
	    <input name="number" type="text" class="textbox textbox_295" placeholder="票数"/><br>
