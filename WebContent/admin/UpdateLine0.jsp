	...
	路线名称：
	 ...
	 始 发 站 ：
		...
		<select name="station2" id="station2" class="select">
	    	<option>请先选择起始站点在选择本站点</option>
	    	
	    </select><br>
	    
	     下 一 站 ：
		<select name="station3" id="station3" class="select">
	    	<option>请先选择上方站点在选择本站点</option>
	    </select><br>  
		...
		<select name="station32" id="station32" class="select">
	     ...
	     下 一 站 ：
		<select name="station33" id="station33" class="select">
	    	<option>请先选择上方站点在选择本站点</option>
	    </select><br>  
	        
	     下 一 站 ：
		<select name="station34" id="station34" class="select">
	    	<option>请先选择上方站点在选择本站点</option>
	    </select><br>  
	        
	     下 一 站 ：
		<select name="station35" id="station35" class="select">
	    	<option>请先选择上方站点在选择本站点</option>
	    </select><br>  
