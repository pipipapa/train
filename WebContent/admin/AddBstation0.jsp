...
<body>
	...
	<form action="AddBstation" method="post">
	 间 隔 时 间：   <input name="time" type="text" id="time" class="textbox textbox_295" placeholder="驶过两站时间（分钟）"/><br>
	    ...
	    本 站 I D：<input name="selfstation" id="selfstation" readonly="readonly" type="text" class="textbox textbox_295" placeholder="请选择站点名称！"/><br>
	   ...
	   下一站ID：<input name="nextstation" id="nextstation" readonly="readonly" type="text" class="textbox textbox_295" placeholder="请选择站点名称！"/><br>
